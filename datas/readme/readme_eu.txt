...
1. Nola ikusi fitxategiak:
  - Egin klik Gehitu fitxategia nire dokumentuan txt gehitzeko.
...
3. Botoiaren Mitt Funtzio eremua aldatzeko:
  ...
  - Zenbait funtzio ezar ditzakezu, pantaila osoa, orrialde mugimendua, distira doitzea eta bolumen kontrola.
  
  - Bluetooth urruneko kontrola ere onartzen da, etzan zaitezke eta eroso ikusi ahal izango duzu.


4. Letra-tipo edo letra-tamaina aldatzeko:
  - Letra-tipoaren edo letra-tipoaren tamaina ezarpenen azpian alda dezakezu - Ezarpenak - Letra-ezarpenak.
  
  - Letra-tipoa erabil dezakezu deskarga botoia sakatuta, doako letra doakoak jasotzeko.


5. Nola erabili irudien testu bihurketa:
  - Testua konprimitutako irudi batetik atera dezakezu.
  
  - OCR funtzioa deritzo.
  
  - Nire aldizkaria - Egin klik Gehitu fitxategia eta gehitu zip fitxategia.
  
  - ZIP fitxategia hautatuta bihur dezakezu eta ondoren OCR menua hautatuz.
  
  - Orrialdea bihurketa garaian kontsumitzen da.

  - OCR AIrekin lan egiten du, beraz, abiadura eta zehaztasuna nahiko onak dira.
...
7. Nola konfiguratu TTS:
  - TTS lotutako ezarpenak ezarpenetan kontzentratzen dira - TTS ezarpenak, TTS iragazkiaren ezarpenak.
  
  - TTS ezarpenak TTS funtzio sinpleak dira, hala nola ahotsa, abiadura, bolumena, botoiaren gardentasuna, esaldiak amaitutako esaldiak eta esaldi kopurua aldi berean irakurtzen dutenak, baita TTS funtzioak osatzen dituzten gailuak ere.
  
  - Garai batean irakurtzen den esaldi kopurua gehitutako funtzioa da, hainbat lerrok behin baino gehiagotan irakur dezaten atzerapen minimoarekin entzuteko.
  ...
  - Deskargatzeko botoia sakatzen baduzu, egin ditudan dozenaka iragazki deskarga ditzakezu.
...
8. Babeskopia eta berreskurapen gaitasunen deskribapena:
  - Konfigurazioa - Babeskopia eta berreskurapena gailu anitzek aplikazioa ingurune berean erabiltzeko aukera ematen duen funtzioa da.
  
  - Backup berreskuratzeko unitatean saioa egin dezakezu.
  ...
  - Hautatu autosinchronizatu nahi duzun gailua eta aktibatu autosinchronizazio funtzioa aplikazioa exekutatzen duzunean edo etxera joan eta itzultzeko azken tokira automatikoki mugitzeko.


9. Nola erabili Testu Batch aldaketa:
  - 1. [SET-SET-SET-Erakutsi Editatu botoia]
  
  - 2. [Ezarpenak - Bulkatutako testuaren aldaketa]
  
  - Lote aldaketa bi modutan erabil dezakezu.
  ...
  - 2. zenbakia izanez gero, testua OCR-rekin atera dezakezu eta hautatu testu fitxategia dokumentuan, lote zuzenketa egiteko.
  
  - Deskargatzeko botoia ere erabil dezakezu testuaren zuzenketa loteetarako errekonozimendu akatsak deskargatzeko eta erabiltzeko.
  
  - Ontziratu gabeko zuzenketak - Deskargak zerrendak bakarrik erakutsiko ditu hizkuntza ezarpenak korearrean badaude.
  
  - Garatzaileek ez dutelako beste hizkuntzarik hitz egiten.
  
  - Txosten funtzioa erabiliz salatzen baduzu, herrialdearen hizkuntza gehituko dut.
...
11. Orrialdeari lotutako deskribapena:
  ...
  - Orrialde gehienak litekeena da OCR, EPUB eta PDF testua ateratzean sentitzea.
  ...
  - Oso zaila zen inplementatzea, beraz, ulermena eskatzen dut.
...
12. Publizitatearen deskribapena:
  ...
  - Iragarkiak kentzean, orria erabil dezakezu iragarkiak denbora jakin batean kentzeko. (Lo egiteko denbora kenduta, egun bat inguru da.)

  - Aurrez pilatutako orriak direnentzat, ikuslearen alboko iragarkia kendu dezakezu 2000 orrialde kontsumituz.
  ...
  - Bihurketa handian zehar agertzen diren iragarki laburrek traba egiten dutenentzat 8000 orrialde gehitu dira.


13. Belarriaren deskribapena (Historia lan egitea):
  - Belarriko ikuspegiaren funtzioa onartzen du.
  
  - Adibidez, esan dezagun A (1etik 50era) izenburuko dokumentua dugula, eta izeneko dokumentu berria dugu (1 eta 100).
  
  - Kasu honetan, beharrezkoa da posizio nagusia saltatzea.
  
  - Nire liburutegian testu fitxategi bat hautatzen duzunean, belarriaren ikuspegia menua agertzen da.
  
  - Menua hautatzen baduzu eta ondoren (1 eta 50) hautatu Historian, automatikoki ikusitako posizioa automatikoki salatuko da.

  - Geroago denbora baduzu, kendu (1-50) historiatik.

  - Historian, irakurtzeko liburu kopurua ere zenbatzen da.
  
  - Dokumentu bera geratzen bada, informazio okerra bistaratu daiteke.
...
14. Laster-marka / Oharra / Deskribapena:
  ...
  - Oharrak funtzioak fitxategi bat hautatzeko eta sartzeko aukera ematen du gutxienez behin ireki baduzu.
...
14. TTS Sententzia azterketariaren deskribapena:
  - Dokumentu asko begiratu nituenean, ondo idatzitako eta idatzitako testuen eredua ikusten hasi nintzen.

  - Zorigaiztoko testuetan beti ateratzen den patroia aurkitu dut.
  
  - Eredu hau antolatu nuen eta eredu bakoitza pisatuz ekoiztu nuen.

  - Hasieran [nire bilaketa] izendatu genuen.
  
  - Hala ere, funtzio hau epai subjektibo gehiegi egin zen, beraz, TTS esaldi zuzentzaileari aldatu nion.

  - Ezaugarri honek Koreako bakarrik onartzen du.

  - Ez dakit beste herrialde batzuetako hizkuntza, beraz, ezin ditut nire ereduak antolatu ona edo txarra den ala ez.

  - Horrelako eredu bat badago beste herrialde batzuetan, bidali iezaguzu posta elektroniko bidez.
...
15. Txakurraren administrazioaren funtzioaren azalpena:
  ...
  - Irekitako akats ugari dituzten dokumentuak aztertuta eta ereduak antolatzen dituen funtzioa da.

  - Ai antolatzen saiatu nintzen, baina ez da erraza izan.
  
  - Egun hauetan hizkuntza naturalaren prozesamenduari buruzko ikerketa ugari dago, beraz, gehituko dut AIrekin prozesatu ahal badut.
...
16. Itzulpen funtzioaren deskribapena:
  ...
  - Itzulpen funtzioa ezarpenetan aktibatzen baduzu - itzulpen ezarpenak eta luze sakatu esaldia, itzulpen funtzioak funtzionatuko du.


17. Beste kontu batzuk:
  - Dokumentu bat irekitzen duzunean, hiru aldiz baino gehiago errepikatzen duen sarrera bi aldiz igaroko da.

  - Gehiegizko sarrera deserosoa da TTS-ekin entzutea eta deseroso ikustea.

  - Zuregatik nabil dagoeneko nire aplikazioa denbora luzez erabiltzea. "Hmm? Zuetako batzuek pentsa dezakete", ez dut sekula entretenimendu asko ikusi ".

  - Testu ikusleak onartzen duen bezainbeste funtzionalitate ezarri dugu.
