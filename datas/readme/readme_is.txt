...
4. Að breyta letri eða leturstærð:
  ...
  - Þú getur notað leturgerðina með því að ýta á niðurhnappinn til að fá tugi ókeypis leturgerða.


5. Hvernig á að nota umbreytingu myndatexta:
  - Þú getur dregið texta úr þjöppuðu mynd.
  
  - Þetta er kallað OCR aðgerðin.
  
  - Tímaritið mitt - Smelltu á Bæta við skrá og bættu við zip skrá.
  
  - Þú getur umbreytt með því að velja ZIP skrána og síðan valið OCR valmyndina.
  
  - Síðan er neytt við viðskipti.

  - OCR vinnur með AI, þannig að hraði og nákvæmni eru nokkuð góðir.
...
7. Hvernig á að setja upp TTS:
  ...
  - TTS stillingarnar innihalda einfalda TTS eiginleika, svo sem rödd, hraða, hljóðstyrk, gagnsæi hnappsins, stafi sem ljúka setningum og fjölda setninga sem lesnar eru í einu, svo og tæki sem bæta við TTS lögunina.
  
  - Fjöldi setninga sem lesnar eru í einu er aðgerð sem bætt er við til að leyfa að lesa margar línur í einu að heyra með lágmarks seinkun.

  - TTS sían er einn öflugasti eiginleiki þessa forrits.
  
  - [TTS síunarstillingar] gerir þér kleift að stilla fjölda sérstakra stafa, orða eða setninga sem þú þarft að sleppa.
...
8. Lýsing á afritunar- og bata getu:
  ...
  - Þú getur skráð þig inn í drifið til að bata afritunar.
  
  - Þegar þú ert skoðaður úr mörgum tækjum, svo sem tölvum, símum og púðum, geturðu notað öryggisafrit til að samstilla útsýnisstaðinn þinn.
  
  - Veldu tækið sem þú vilt sjálfkrafa og kveikja á AutoSynchronization aðgerðinni til að fara sjálfkrafa yfir á síðasta stað þegar þú keyrir forritið eða fer heim og kemur aftur.


9. Hvernig á að nota breytingu á textahópi:
  -1. [Set-Set-Set-Sýning Breyta hnappinn]
  
  - 2. [Stillingar - Breyting á lausu texta]
  
  - Þú getur notað lotubreytingar á tvo vegu.
  ...
  - Þú getur líka notað niðurhalshnappinn til að hlaða niður og nota oft viðurkenningarvillur fyrir lotu leiðréttingu texta.
...
10. Ef það er ógeðsleg setning þegar þú hlustar á TTS skaltu vinna úr því:
  ...
  - Ef þú vilt fjarlægja frumritið aðeins frá TTS án þess að snerta það, notaðu TTS síuna.
...
11. Lýsing á blaðsíðu:
  ...
  - Líklegt er að flestar síður séu notaðar til að finna þegar þú dregur út texta úr OCR, EPUB og PDF.

  - Þegar við dregum út texta, þá dregur við ekki aðeins úr höndunum, heldur skipuleggjum einnig setningar með því að gera tugi vandamála sem koma fram eftir útdrátt í mynstur.

  - Það var mjög erfitt að hrinda í framkvæmd, svo ég bið um skilning þinn.
...
12. Auglýsingalýsing:
  ...
  - Auglýsingar fela í sér blaðsíðu-auglýsingar og auglýsingar auglýsingar.
  ...
  -Fyrir þá sem eru forstilla síður geturðu fjarlægt auglýsingu áhorfandans með því að neyta 2000 blaðsíðna.

  - Þegar þú neytir 8000 blaðsíðna eru allar auglýsingar óvirkar nema fyrir 30 sekúndna auglýsingar til að öðlast síðu og innfæddar auglýsingar í miðri stillingum.

  - 8000 blaðsíðna auglýsingar hafa verið bætt við fyrir þá sem eru að nenna stuttum auglýsingum sem birtast við mikið umbreytingu.


13. Lögun Lýsing fyrir eyran (söguverkun):
  - Það styður eyrnasýn.
  
  - Til dæmis skulum við segja að við höfum skjal sem heitir A (1 til 50) og við erum með nýtt skjal sem heitir A (1 til 100).
  
  - Í þessu tilfelli er nú þegar nauðsynlegt að sleppa aðalstöðu.
  
  - Þegar þú velur textaskrá á bókasafninu mínu birtist eyrnaskjávalmyndin.
  
  - Ef þú velur þessa valmynd og velur síðan A (1 til 50) í sögunni, sleppir það sjálfkrafa áður skoðaðri stöðu.

  - Þegar þú hefur tíma seinna skaltu fjarlægja A (1-50) úr sögunni.
...
14. Bókamerki/athugasemd/með aðalhlutverk:
  ...
  - Hægt er að nota bókamerki til að taka upp mikilvægt efni.



14. TTS Setning prófdómari Lýsing:
  -Þegar ég skoðaði mörg skjöl byrjaði ég að sjá mynstur vel skrifaðs og ekki skrifaðs texta.
  ...
  - Hins vegar var þessi aðgerð gerð með of huglægum dómi, svo ég breytti henni í TTS setningaratriði.
  ...
  - Ef það er mynstur eins og þetta í öðrum löndum, vinsamlegast sendu það til okkar með tölvupósti.
  
  - Þegar þú getur stutt mörg þjóðmálum munum við færa aðgerðina yfir í stillingar.

  - Það er enn einn staðurinn eftir í stillingunum.
...
15. Útskýring á virkni hundastjórnarinnar:
  ...
  - Venjulega gerist þetta mikið að skjölum sem eru unnin með OCR umbreytingu.

  - Þessi eiginleiki er ekki bara sambland af Enter.
...
16. Þýðingaraðgerð Lýsing:
  - Staðbundin þýðing / þýðingarvirkni vafra er studd.
...
17. Önnur mál:
  - Þegar þú opnar skjal verður færslan sem endurtekur meira en þrisvar opnað með því að skipta yfir í tvisvar.
