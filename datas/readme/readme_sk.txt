...
3. Zmeniť oblasť funkcie Button Mitt:
  - Môžete ho zmeniť v nastaveniach - Nastavenia oblasti dotyku.
  
  - Môžete nastaviť množstvo funkcií vrátane úplnej obrazovky, pohybu stránky, nastavenia jasu a ovládania hlasitosti.
  
  - Bluetooth diaľkové ovládanie je tiež podporované, takže si môžete ľahnúť a pohodlne ho sledovať.


4. Zmena veľkosti písma alebo písma:
  - Môžete zmeniť veľkosť písma alebo písma v časti Nastavenia - Nastavenia - Nastavenia písma.
...
5. Ako používať konverziu textu obrázka:
  - Môžete extrahovať text z komprimovaného obrázka.
  
  - Toto sa nazýva funkcia OCR.
  
  - Môj denník - kliknite na Pridať súbor a pridajte súbor zip.
  
  - Môžete previesť výberom súboru ZIP a potom výberom ponuky OCR.
  
  - Stránka sa spotrebuje počas konverzie.

  - OCR pracuje s AI, takže rýchlosť a presnosť sú celkom dobré.


6. Epub, Metóda konverzie PDF:
  - Je to rovnaké ako metóda konverzie obrázka.

  - Existuje niekoľko vecí, o ktorých je potrebné vedieť.

  - EPUB alebo PDF môžu byť „šifrované“.

  - Používa sa hlavne na prelomenie písmen a zviditeľnenie iba v určitých písmach.
...
7. Ako nastaviť TTS:
  ...
  - Nastavenia TTS obsahujú jednoduché funkcie TTS, ako sú hlas, rýchlosť, hlasitosť, priehľadnosť tlačidla, znaky končiace vety a počet viet čítaných súčasne, ako aj zariadenia, ktoré dopĺňajú funkcie TTS.
  
  - Počet viet čítaných naraz je funkcia pridaná, ktorá umožňuje čítanie viacerých riadkov naraz s minimálnym oneskorením.

  - Filter TTS je jednou z najvýkonnejších funkcií tejto aplikácie.
  ...
  - [Funkcia automatického vypnutia] môže nastaviť automatický čas vypnutia dotykom ikony v tvare mesiaca na ľavej strane tlačidla zastavenia pri prehrávaní TTS.


8. Popis schopností zálohovania a obnovy:
  - Nastavenie - Zálohovanie a obnovenie je funkcia, ktorá umožňuje viacerým zariadeniam používať aplikáciu v rovnakom prostredí.
  
  - Môžete sa prihlásiť na jednotku na obnovenie zálohovania.
  
  - Pri pohľade z viacerých zariadení, ako sú počítače, telefóny a podložky, môžete na synchronizáciu pozerania použiť zálohu polohy.
  
  - Vyberte zariadenie, ktoré chcete autosynchronizovať, a zapnite funkciu autosynchronizácie, aby ste sa automaticky presunuli na posledné miesto, keď spustíte aplikáciu alebo pôjdete domov a vrátite sa.


9. Ako používať modifikáciu textovej dávky:
  -1. [SET-SET-SET-SHOW TLAČIDLO EDIT]
  
  - 2. [Nastavenia - modifikácia hromadného textu]
  
  - Môžete použiť modifikáciu dávky dvoma spôsobmi.
  
  - V prípade čísla 1 sa používa na počúvanie TTS a na vymazanie alebo zmenu vety na iný znak, ak sú niektoré vety alebo slová nepríjemné.
  
  - V prípade čísla 2 môžete text extrahovať pomocou OCR a vyberte textový súbor z dokumentu, aby ste vykonali korekciu šarže.
  
  - Môžete tiež použiť tlačidlo sťahovania na sťahovanie a používanie často vyskytujúcich chýb rozpoznávania na korekciu dávky textu.
...
11. Popis súvisiaci s stránkou:
  - Ak používate špeciálne funkcie, ako je kontrola vety TTS, korekcia dávky, reorganizácia riadkov a preklad, stránky sa budú konzumovať, ale keďže je to asi 10 až 50, nebudete sa cítiť konzumovaný.

  - Väčšina strán je pravdepodobne použitá na to, aby sa cítila pri extrahovaní textu z OCR, EPUB a PDF.

  - Pri extrakcii textu nielen extrahujeme jednotlivé ruky, ale tiež organizujeme vety tým, že robíme desiatky problémov, ktoré sa objavia po extrakcii do vzorcov.

  - Bolo to naozaj ťažké implementovať, takže žiadam o vaše porozumenie.


12. Popis reklamy:
  - Som vývojár aj používateľ.

  - Pridali sme reklamy do rozsahu, v akom nezasahujú do čo najviac používania.

  - Reklamy zahŕňajú reklamy zabezpečené stránky a reklamy na odstraňovanie reklamy.

  - Stránka môže vydržať až 60 000 strán.

  - Pri odstraňovaní reklám môžete túto stránku pomocou reklám na určité časové obdobie odstrániť. (Okrem času spánku, je to asi deň.)

  -Pre tých, ktorí sú predbežnými stránkami, môžete odstrániť reklamu na strane diváka konzumáciou 2000 strán.
  ...
  - Pre tých, ktorých obťažujú krátke reklamy, ktoré sa objavia počas veľkého množstva konverzie, boli pridané 8000 strán reklám.


13. Popis funkcie pre ucho (interworking histórie):
  - Podporuje funkciu zobrazenia ucha.
  
  - Napríklad povedzme, že máme dokument s názvom A (1 až 50) a máme nový dokument s názvom A (1 až 100).
  
  - V tomto prípade je už potrebné preskočiť hlavnú pozíciu.
  
  - Keď vyberiete textový súbor v mojej knižnici, zobrazí sa ponuka Zobrazenie ucha.
...
14. Popis skúšajúceho TTS vety:
  ...
  - Zorganizoval som tento vzor a vytvoril som ho vážením každého vzoru.
  ...
  - V nastaveniach stále zostáva jedno miesto.
...
15. Vysvetlenie funkcie správy psov:
  ...
  - V týchto dňoch je veľa výskumov v oblasti spracovania prirodzeného jazyka, takže ho pridám, ak ho dokážem spracovať pomocou AI neskôr.


16. Popis funkcie prekladu:
  - Je podporovaná funkcia prekladu miestneho prekladu / webového prehľadávača.
  
  - Lokálny preklad je funkcia, ktorá sa prekladá do AI vyvinutej spoločnosťou Google. Jednoduché slová je možné preložiť dobre, ale zdá sa, že pri preklade vety je veľa nesprávnych prekladov.
...
17. Ostatné záležitosti:
  ...
  - Nadmerný vstup je nepohodlné počúvať s TTS a nepohodlné vidieť.
  ...
  - implementovali sme toľko funkcií, ako môže prehliadač textu podporovať.
